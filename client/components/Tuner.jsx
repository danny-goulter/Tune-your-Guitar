...
function Tuner () {
  return (
    <>
      ...
      <p>Learning to tune your Guitar is relatively straight-forward when compared to actually learning to play and it should definitely be the first skill you master when you begin to learn the instrument.<br></br></p>
      <div className="tuner">
        <img className="guitar" src="./images/guitar.png" alt="a guitar and its tuning pegs"/>
        <p><strong>Clicking on each of the buttons below will play an audio recording of what each string should sound like, you can use this to adjust the tuning pegs on your<br></br> Guitar until you can hear the same sound.</strong></p>
