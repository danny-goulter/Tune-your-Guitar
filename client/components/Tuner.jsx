  ...
  return (
    <>
      ...
      <div className="tuner">
        ...
        <p><strong>Clicking on each of the buttons below will play an audio recording of what each string should sound like, you can use this to adjust the tuning pegs on your Guitar until you can hear the same sound.</strong></p>
